...
export class RagService {
  ...
  // BYO-LLM: embedding model + dimension are env-configurable so a non-Ollama
  // backend (e.g. vLLM serving a non-nomic embedding model) can set the right
  // vector size. Defaults match upstream's nomic-embed-text:v1.5 (768-dim).
  public static EMBEDDING_MODEL = env.get('EMBEDDING_MODEL', 'nomic-embed-text:v1.5')
  public static EMBEDDING_DIMENSION = parseInt(env.get('EMBEDDING_DIMENSIONS', '768'))
