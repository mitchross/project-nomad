...
export class ZimService {
  ...
  async registerLocalUpload(filename: string): Promise<{ added: number }> {
    ...
    // shapes — deployment-agnostic: local/remote Ollama, vLLM, EMBEDDING_HOST).
    // The EmbedFileJob does its own readiness gating and permanently skips if
    // the backend truly isn't there.
