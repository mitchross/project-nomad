        ...
        async onComplete(url) {
          ...
          try {
            ...
            if (filetype === 'zim') {
              ...
              // configured for this deployment (see
              // OllamaService.isEmbeddingBackendConfigured for the shapes).
              ...
              if (
                (await OllamaService.isEmbeddingBackendConfigured(dockerService)) &&
                !resourceMetadata?.skip_embedding
              ) {
