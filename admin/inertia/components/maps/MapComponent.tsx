    ...
    <MapProvider>
      ...
      >
        <Map
          ...
          // Use origin (not protocol+hostname+port) so the URL stays correct
          // behind a reverse proxy on 443/HTTPS, where window.location.port is
          // empty and the manual form would yield a malformed "https://host:/…".
